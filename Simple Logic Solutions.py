...
#2.3
for i,x in enumerate (influenza_genome): #Using enumerate method to create index variable i for the value in list x. 
    if 233<i<238 and i == 236:           #using for loop to check values between 234 and 237 and if values is 236, assign the value to "i"
